...
window.SEARCH_INDEX = [
  ...
  { title: "PDF Colour Filters", url: "/pdf-color-filters/", icon: "tonality", desc: "Greyscale, invert, or adjust brightness/contrast/saturation", category: "PDF Tool" },
  ...
  { title: "Sanitise PDF", url: "/sanitize-pdf/", icon: "cleaning_services", desc: "Strip embedded scripts, auto-actions, attachments and metadata", category: "PDF Tool" },
  ...
  { title: "Posterise PDF", url: "/posterize-pdf/", icon: "grid_on", desc: "Blow up a page across multiple sheets for large-format printing", category: "PDF Tool" },
  ...
  { title: "Image Colour Filters", url: "/image-color-filters/", icon: "palette", desc: "Greyscale, sepia, brightness, contrast and saturation", category: "Image Tool" },
  ...
  { title: "Colour Picker & Converter", url: "/color-picker/", icon: "colorize", desc: "Pick a colour and convert between HEX, RGB and HSL live", category: "Utility" },
